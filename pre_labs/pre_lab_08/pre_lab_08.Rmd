...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
We specified the type of graph we want, a bar graph (geom_bar). The x-axiz shows the county and the total differences are on the y axis but they are not in a particular order.
