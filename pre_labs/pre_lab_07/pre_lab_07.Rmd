...
**Answer**
The largest percent change is Nevada.
...
**Answer** Yes, this is significant they don't overlap.

Is the difference between Howard and everyone else significant?
**Answer**
Howard is statistically significant when it comes to Calvert County, Charles County,Queen Anne's and St.Mary. 
...
**Answer**
None of the counties median income decreased between 2010-2020 and yes it is for both.
```{r}
md10 %>%
...
**Answer** 
ZCTA5 20609 has an estimated median household income of less than $50,000.
```{r}
...
**Answer** I'm assuming they're suburban, I wonder what's the (majority) community's demographic? Does the zip code have more families than other zipcodes and equates to a higher median income?