...
**Answer** 
The end of "Bend" should not be it's own category. 
...
**Answer**
Percentages in the turnout section needs to be changed to a different format.
...
**Answer** 
There's twent-one rows versus twenty-three rows. 
```{r}
