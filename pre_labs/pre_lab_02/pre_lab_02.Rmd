...
**Answer** This code is assigning a column labeled as Election day percentage. "Select" impacts what we see in the output. The percentage will now be apart of our votes. Mutate is not permanent unless we save it to a new variable. 
...
**Answer** This creates a better format of how percentages look for readers. It shows percentages not in decimal form, it's easily readable. It is now in order of highest percentage of election day. 
...
**Answer**
Yes, because it shows a more accurate representation between votes and percentages. 
...
**Answer**
tolower() is used to take uppercase numbers to lowercase. str_length is also used to find out how long a string is. 
...
**Answer** 
This statement is using mutate to categorize donations by minimum and maximum amount, it provides a range of how donations are given: Donations less than $100, Donations from $100-500, Donations from $500-$2900, and Donations greater than $2900. 
```{r}
maryland_winred_categories <- wvmaryland_winred %>%
  mutate(
...
**Answer** 
The largest category is the "less than $100"
...
**Answer** This is important because you have a new name for Prince George  county only. We specified to one county instead of the entire state of Maryland.
...
##Question about this ^^ 
I get the "10" candidates but why did 355 occur? Is it 355 governor and lieutenant candidates??
...
**Answer** June had the most expenses when it came to campaigns spending money. February has the least, I'm assuming people used more money the closer it came to elections.
