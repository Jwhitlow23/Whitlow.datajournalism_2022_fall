...
**A1.** 
Hogan beat Cox in all of Maryland's counties. Talbot had the highest percent different of thirty percent. The lowest percent difference was in Somerset. For some reason, St. Mary's data did not show up at all, it was the only county but I believe this is user error. 
...
# Just make chart in datawrapper 
```
...
**A3.** 
I had trouble trying to filter the zip codes, I will come back 
filter(24001,24003,24510,24005,24009,24011,24013,24015,24017,24019,24021,24023,24025,24027,24029,24031,24033,24035,24037,24039,24041,24043,24045,24047)
)
```{r}
